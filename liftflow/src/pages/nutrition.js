...
export default function Nutrition() {
  ...
  return (
    <div style={wrap}>
      ...
      <section className="nutrition-hero" style={heroCard}>
        <MacroHero
          label="Calories"
          value={caloriesToday}
      ...
      <section style={card}>
        ...
        <div style={dayList}>
          {recentDays.map((day) => (
            <div key={day.key} className="nutrition-day-row" style={dayRow}>
              <div>
...
function MacroLogger({ title, value, target, quickAmounts, customValue, setCustomValue, onAdd, onSet, unit = "", color }) {
  ...
  return (
    <section style={card}>
      ...
      <div className="nutrition-quick-grid" style={quickGrid}>
      ...
      <div className="nutrition-custom-row" style={customRow}>
        <input
          type="number"
