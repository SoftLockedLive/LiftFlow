export const PROGRAM_TEMPLATES = [
  ...
  },
  {
    id: "peyto-split",
    name: "Peyto Split",
    summary: "ULPPL powerbuilding split for bench strength, hypertrophy, abs, and conditioning.",
    days: {
      Monday: day("Upper (Bench Strength)", [
        lift("Barbell Bench Press", "chest", "4", "4-6", "Band pull-aparts, shoulder circles, 2-3 ramp-up sets"),
        lift("Chest-Supported Row", "back", "4", "6-8", "Light rows, lat stretch"),
        lift("Weighted Pull-Ups / Lat Pulldown", "back", "3", "6-10", "Dead hang, scap pull-ups"),
        ...
        lift("EZ-Bar Curl", "arms", "3", "8-12", "Wrist and elbow circles"),
        lift("Tricep Pushdown", "arms", "3", "10-15", "Elbow circles"),
        lift("Hanging Leg Raise", "core", "3", "8-15", "Cat-cow, bracing breaths"),
      ]),
      Tuesday: day("Lower (Squat Strength)", [
        lift("Back Squat", "legs", "4", "4-6", "Hip flexor stretch, ankle rocks, ramp-up sets"),
        lift("Romanian Deadlift", "legs", "3", "6-10", "Hamstring sweeps, hip hinge drill"),
        lift("Leg Press", "legs", "3", "8-12", "Bodyweight squats"),
        lift("Seated Leg Curl", "legs", "3", "10-15", "Light hamstring curls"),
        lift("Standing Calf Raise", "legs", "4", "8-15", "Ankle rocks"),
        lift("Cable Crunch", "core", "3", "10-15", "Cat-cow, bracing breaths"),
      ]),
      Wednesday: recovery("Conditioning + Recovery", "Zone 2 Cardio + Full-Body Mobility", "25-40 min cardio, 10-15 min mobility", "Easy", "Keep cardio conversational and mobility smooth."),
      Thursday: day("Push (Bench Volume + Hypertrophy)", [
        lift("Paused Barbell Bench Press", "chest", "3", "6-8", "Band pull-aparts, paused ramp-up sets"),
        lift("Incline Dumbbell Press", "chest", "3", "8-12", "Light incline presses"),
        lift("Seated Dumbbell or Smith Machine Overhead Press", "shoulders", "3", "8-12", "Shoulder circles, wall slides"),
        lift("Cable Fly", "chest", "2", "12-20", "Light flys, pec stretch"),
        lift("Cable Lateral Raise", "shoulders", "4", "12-20", "Shoulder circles"),
        lift("Overhead Cable Tricep Extension", "arms", "3", "10-15", "Elbow circles"),
        lift("Tricep Pushdown", "arms", "3", "10-15", "Elbow circles"),
      ]),
      Friday: day("Pull (Deadlift Strength)", [
        lift("Conventional Deadlift", "back", "3", "3-5", "Hip hinge drill, hamstring sweeps, ramp-up sets"),
        lift("Weighted Pull-Ups / Lat Pulldown", "back", "3", "6-10", "Dead hang, scap pull-ups"),
        lift("Chest-Supported Row", "back", "3", "8-12", "Light rows, lat stretch"),
        lift("Single-Arm Cable Row", "back", "2", "10-15", "Light cable rows"),
        lift("Reverse Pec Deck", "shoulders", "3", "12-20", "Band pull-aparts"),
        lift("Preacher Curl", "arms", "3", "8-12", "Wrist and elbow circles"),
        lift("Hammer Curl", "arms", "3", "10-15", "Wrist circles"),
        lift("Ab Wheel Rollout", "core", "3", "6-12", "Cat-cow, bracing breaths"),
      ]),
      Saturday: day("Legs (Hypertrophy)", [
        lift("Hack Squat", "legs", "3", "6-10", "Ankle rocks, bodyweight squats"),
        lift("Bulgarian Split Squat", "legs", "3", "8-12/leg", "Hip opener, bodyweight split squats"),
        lift("Leg Extension", "legs", "3", "10-15", "Light leg extensions"),
        lift("Seated Leg Curl", "legs", "3", "10-15", "Light hamstring curls"),
        lift("Seated Calf Raise", "legs", "4", "10-20", "Ankle rocks"),
        lift("Cable Crunch", "core", "3", "10-15", "Cat-cow, bracing breaths"),
      ]),
      Sunday: recovery("Rest", "Full Rest Day", "All day", "Easy", "No training. Eat, sleep, and recover."),
    },
  },
];
